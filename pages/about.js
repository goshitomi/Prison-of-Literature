      ...
      <main>
        ...
        <section style={{
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <div style={{ fontSize: 12, color: "rgba(255,255,255,0.45)", letterSpacing: "0.05em" }}>
        ...
        <section style={{
          ...
          <div style={{
            ...
            <p style={{ fontSize: 14, lineHeight: 2.1, fontWeight: 300,
                        color: "#444", marginBottom: 18 }}>
          ...
          <div style={{ padding: "64px 32px 64px 48px" }}>
            ...
            <p style={{ fontSize: 14, lineHeight: 2.1, fontWeight: 300,
              ...
              as a prisoner&rsquo;s personal profile. The title functions as the inmate&rsquo;s name,
              while trim size and weight are redefined as physical attributes. The date of first
              publication serves as the prisoner&rsquo;s date of birth, and the ISBN takes on the
              role of an inmate identification number.
            </p>
            <p style={{ fontSize: 14, lineHeight: 2.1, fontWeight: 300, color: "#444" }}>
              Stripped of their original covers, all books are garbed in standardized
              &lsquo;prison uniforms&rsquo; categorized into S, M, and L sizes, with their inmate
              numbers displayed on the spine.
            </p>
          </div>
        </section>
